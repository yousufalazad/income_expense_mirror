    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                <form action="{{ route('half-yearly-fixed-income.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <button type="submit" class="btn btn-primary btn-block px-4 my-3">{{ __('Save Half Yearly Income') }}</button>
                </form>
                </div>
            </div>
        </div>
