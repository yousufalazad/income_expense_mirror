    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                    ...
                    <div class="row">
                        <div class="col">
                            <h6 class="font-weight-bold text-primary">
                                {{ __('Add One Time Income') }}
                            </h6>
                        </div>
                        <div class="col" style="text-align: right;">
                            <a href="{{ route('one-time-income.index') }}" class="btn btn-primary">
                ...
                <div class="card-body">
                <form action="{{ route('one-time-income.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
