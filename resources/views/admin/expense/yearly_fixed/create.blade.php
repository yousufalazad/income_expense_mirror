    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                    ...
                    <div class="row">
                        <div class="col">
                            <h6 class="font-weight-bold text-primary">
                                {{ __('Add Yearly Fixed Expense') }}
                            </h6>
                        </div>
                        <div class="col" style="text-align: right;">
                            <a href="{{ route('yearly-fixed-expense.index') }}" class="btn btn-primary">
                ...
                <div class="card-body">
                <form action="{{ route('yearly-fixed-expense.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <button type="submit" class="btn btn-primary btn-block px-4 my-3">{{ __('Save Yearly expense') }}</button>
                </form>
                </div>
            </div>
        </div>
