    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                    ...
                    <div class="row">
                        <div class="col">
                            <h6 class="font-weight-bold text-primary">
                                {{ __('Add Quarterly Fixed Expense') }}
                            </h6>
                        </div>
                        <div class="col" style="text-align: right;">
                            <a href="{{ route('quarterly-fixed-expense.index') }}" class="btn btn-primary">
                ...
                <div class="card-body">
                <form action="{{ route('quarterly-fixed-expense.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
